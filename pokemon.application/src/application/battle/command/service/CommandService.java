package application.battle.command.service;
...
public class CommandService implements IApplicationService<CommandInputDto, CommandOutputDto> {
	...
	public CommandOutputDto execute(CommandInputDto input){
		...
		//TODO 
		System.out.println("CommandService execute");
	 ...
	 * @return
	 */
	private CommandOutputDto MockBattle(CommandInputDto input){
	 ...
	 * 先攻後攻の決定
	 */
	private void determineFirst(CommandInputDto input){
	 ...
	 * @return
	 */
	private int calculateDamage(CommandInputDto input){
